...
namespace Constants {
    ...
    inline constexpr float BALL_WIDTH{20.0f};
    inline constexpr float BALL_HEIGHT{20.0f};
    ...
    inline constexpr float PADDLE_WALL_DISTANCE{50.0f};
