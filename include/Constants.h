...
namespace Constants {
    ...
    inline constexpr int MAX_BUFFER_CAPACITY{1000000};
    inline constexpr int BATCH_SIZE{64};
    inline constexpr float LEARNING_RATE{1e-4};
    ...
    inline constexpr int INPUT_LAYER_SIZE{24};
    inline constexpr int HIDDEN_LAYER_SIZE{128};
    inline constexpr int OUTPUT_LAYER_SIZE{3};
    inline constexpr int STACK_SIZE{4};
    inline constexpr int SKIP_FRAMES{4};

    inline constexpr const char* MODELS_PATH{"models/"};
